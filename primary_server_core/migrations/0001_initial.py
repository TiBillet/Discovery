# Generated by Django 4.2.10 on 2024-02-24 14:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server_url', models.URLField(unique=True, verbose_name='Url server')),
                ('server_rsa_pub_pem', models.CharField(blank=True, max_length=512, null=True, unique=True, verbose_name='RSA public pem key')),
                ('locale', models.CharField(default='en', max_length=2, verbose_name='Locale')),
            ],
        ),
        migrations.CreateModel(
            name='ServerAPIKey',
            fields=[
                ...
                ('server', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='api_keys', to='primary_server_core.cashlessserver')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pin_code', models.PositiveIntegerField(blank=True, max_length=8, null=True, unique=True)),
                ('cashless_server', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clients', to='primary_server_core.cashlessserver')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
